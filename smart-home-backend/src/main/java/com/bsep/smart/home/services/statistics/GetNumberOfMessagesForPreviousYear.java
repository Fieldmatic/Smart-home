...
public class GetNumberOfMessagesForPreviousYear {
    ...
    public Map<String, Long> execute() {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            messageCountByMonths.put(yearMonth.getMonth().getDisplayName(TextStyle.FULL, Locale.getDefault()), logRepository.countLogsByCreatedAtBetweenAndProcessedIsTrue(start, end));
        }

        return messageCountByMonths;
    }
}
